...
describe('mquery', function() {
  ...
  describe('sort', function() {
    ...
    it('works with maps', function() {
      ...
      var query = mquery();
      // file deepcode ignore CollectionUpdatedButNeverQueried/test: <please specify a reason of ignoring this>
  ...
  describe('exec', function() {
    ...
    describe('find', function() {
      ...
      it('works with readPreferences', function(done) {
        var m = mquery(col).find({ name: 'exec' });
        try {
          // file deepcode ignore RequireAsConstructor/test: <please specify a reason of ignoring this>
