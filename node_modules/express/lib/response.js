...
res.send = function send(body) {
  ...
  if (chunk !== undefined) {
    ...
    // file deepcode ignore ContentLengthInCode: <please specify a reason of ignoring this>
...
res.jsonp = function jsonp(obj) {
  ...
  if (!this.get('Content-Type')) {
    ...
    // file deepcode ignore ContentTypeNoCharset: <please specify a reason of ignoring this>
    this.set('Content-Type', 'application/json');
  }
